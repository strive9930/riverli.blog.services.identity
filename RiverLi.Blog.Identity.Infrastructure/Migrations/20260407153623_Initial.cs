        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentRoleId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RouteGroups_RouteGroups_ParentId",
                        column: x => x.ParentId,
                        principalTable: "RouteGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    RouteGroupId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FrontendRoutes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FrontendRoutes_FrontendRoutes_ParentId",
                        column: x => x.ParentId,
                        principalTable: "FrontendRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FrontendRoutes_RouteGroups_RouteGroupId",
                        column: x => x.RouteGroupId,
                        principalTable: "RouteGroups",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RouteGroupId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    FrontendRouteId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SysRoutes_RouteGroups_RouteGroupId",
                        column: x => x.RouteGroupId,
                        principalTable: "RouteGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceInfo = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BrowserInfo = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menus_FrontendRoutes_FrontendRouteId",
                        column: x => x.FrontendRouteId,
                        principalTable: "FrontendRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "FrontendRouteSysRoute",
                columns: table => new
                {
                    BackendRoutesId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    FrontendRoutesId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FrontendRouteSysRoute", x => new { x.BackendRoutesId, x.FrontendRoutesId });
                    table.ForeignKey(
                        name: "FK_FrontendRouteSysRoute_FrontendRoutes_FrontendRoutesId",
                        column: x => x.FrontendRoutesId,
                        principalTable: "FrontendRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FrontendRouteSysRoute_SysRoutes_BackendRoutesId",
                        column: x => x.BackendRoutesId,
            ...
            migrationBuilder.CreateTable(
                name: "FrontendRouteSysRoutes",
                columns: table => new
                {
                    FrontendRouteId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    SysRouteId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    CreateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdateTime = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FrontendRouteSysRoutes", x => new { x.FrontendRouteId, x.SysRouteId });
                    table.ForeignKey(
                        name: "FK_FrontendRouteSysRoutes_FrontendRoutes_FrontendRouteId",
                        column: x => x.FrontendRouteId,
                        principalTable: "FrontendRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FrontendRouteSysRoutes_SysRoutes_SysRouteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FrontendRoutes_Name",
                table: "FrontendRoutes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FrontendRoutes_ParentId",
                table: "FrontendRoutes",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_FrontendRoutes_Path",
                table: "FrontendRoutes",
                column: "Path",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FrontendRoutes_RouteGroupId",
                table: "FrontendRoutes",
                column: "RouteGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_FrontendRouteSysRoute_FrontendRoutesId",
                table: "FrontendRouteSysRoute",
                column: "FrontendRoutesId");

            migrationBuilder.CreateIndex(
                name: "IX_FrontendRouteSysRoutes_SysRouteId",
                table: "FrontendRouteSysRoutes",
                column: "SysRouteId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuGroups_Code",
                table: "MenuGroups",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menus_FrontendRouteId",
                table: "Menus",
                column: "FrontendRouteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteGroups_Code",
                table: "RouteGroups",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RouteGroups_ParentId",
                table: "RouteGroups",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_SysRoutes_Path_Method",
                table: "SysRoutes",
                columns: new[] { "Path", "Method" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SysRoutes_RouteGroupId",
                table: "SysRoutes",
                column: "RouteGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLoginHistories_CreateTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLoginHistories_Status",
                table: "UserLoginHistories",
                column: "Status");
